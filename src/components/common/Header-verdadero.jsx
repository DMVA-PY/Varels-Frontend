  ...
  return (
    <div>
      ...
      >
        ...
        {/* BUTTONS */}
        <div className="header-block head-logo-row position-relative transition-soft">
          <div className="container-fluid">
            <div className="js-nav-logo-bar row no-gutters align-items-center">
                ...
                <div id="logo" className="logo-img-container ">
                  <a href="https://barnesindustries.com.ar/" title="">
                    <img
                      ...
                      alt="Varels"
                      className="barnes-icon logo-img transition-soft logo-img-small"
                      width={474}
                      height={49}
                    />
                  </a>
              ...
              {/* BUSCAR BUTTON */}
              <div
                className=" js-search-utility col-auto desktop-utility-col col-md-3 mr-md-5 col-utility  order-md-0"
